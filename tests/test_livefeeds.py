...
from mooquant_ccxt.livefeed import LiveFeed


class TestLiveFeed(TestCase):
    @mock.patch('mooquant_ccxt.livefeed.ts.is_holiday')
    @mock.patch('mooquant_ccxt.livefeed.ts')
    def test__fill_today_bars(self, mock_ccxt, mock_is_holiday):
        ...
        mock_ccxt.get_today_ticks.return_value = df
    ...
    @mock.patch('mooquant_ccxt.livefeed.ts.is_holiday')
    @mock.patch('mooquant_ccxt.livefeed.get_trading_days')
    @mock.patch('mooquant_ccxt.livefeed.ts')
    def test__fill_history_bars(self, mock_ccxt, mock_days, mock_is_holiday):
        data_list = [['09:33:45', 9.10, 100, 2000, 0.01],
                     ['09:33:20', 9.20, 100, 2000, 0.01],
                     ['09:33:00', 9.30, 100, 2000, 0.01],
                     ['09:32:59', 9.40, 100, 10, 0.01],
        ...
        mock_ccxt.get_tick_data.return_value = day2_df
        mock_is_holiday.return_value = False
