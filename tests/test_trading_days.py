...
import mock
from mooquant_ccxt.livefeed import get_trading_days


class TestTradingDays(TestCase):
    @mock.patch('mooquant_ccxt.livefeed.ts')
    def test_get_trading_days(self, mock_ccxt):
        ...
        mock_ccxt.get_hist_data.return_value = df
    ...
    @mock.patch('mooquant_ccxt.livefeed.ts')
    def test_get_trading_days_with_one_holiday(self, mock_ccxt):
    ...
    @mock.patch('mooquant_ccxt.livefeed.ts')
    def test_get_trading_days_with_two_holidays(self, mock_ccxt):
